    ...
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Center(child: Column(children: [
          Container(width: 80, height: 80, decoration: BoxDecoration(color: AppTheme.primaryColor, borderRadius: BorderRadius.circular(20)),
        ...
        Card(margin: const EdgeInsets.symmetric(horizontal: 12), child: Column(children: [
          ...
          const ListTile(title: Text("源代码"), trailing: Icon(Icons.open_in_new, size: 16)),
        ])),
      ]),
    );
  }
